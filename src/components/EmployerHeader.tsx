    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <Link to="/" className="text-2xl font-bold text-brand-dark-blue flex items-center gap-1">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="#" className="text-sm font-medium text-brand-teal hover:underline">Back to Consumer Site</Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 py-4 px-4 space-y-4 shadow-xl">
          ...
          <Link to="#" className="block text-base font-medium text-brand-teal">Back to Consumer Site</Link>
